...
wss.on("connection", ws => {
    ...
    var BotJid = `BabyHubBot@BabyHub.dev/V2:Fortnite:WIN::BabyHub-Bot-By-BeatYT`
    ...
    ws.on('message', (msg) => {
        ...
        switch (doc.root.name) {
            ...
            case "open":
                var build = builder.create('open').att("id", UUID).att('xmlns', 'urn:ietf:params:xml:ns:xmpp-framing').att('from', 'BabyHub.dev')
            ...
            case "iq":
                ...
                switch (doc.root.attributes.id) {
                    case "_xmpp_auth1":
                        {
                            ...
                            Jid = `${accountId}@BabyHub.dev/${resource}`
                    ...
                    case "_xmpp_bind1":
                        ...
                        <iq xmlns="jabber:client" from="BabyHub.dev"
                            to="BeatYT@BabyHub.dev/V2:Fortnite:WIN::B1D5CD0B469E2ADB22F639BFB8620D0D" 
                            type="result" id="_xmpp_bind1">
                            <bind xmlns="urn:ietf:params:xml:ns:xmpp-bind">
                                <jid>BeatYT@BabyHub.dev/V2:Fortnite:WIN::B1D5CD0B469E2ADB22F639BFB8620D0D</jid>
                            </bind>
                        </iq>
                ...
                if (bWaitingForGiftNumValid && giftResults.length > 0) {
                    ...
                    profiledata.items[uuid.v4()] = {
                        ...
                        "attributes": {
                            ...
                            "giftedOn": new Date(),
                            "params": {
                                "userMessage": "Thanks for using BabyHub"
                            },
                            "favorite": false
                        },
                        "quantity": 1
    ...
    var functions = {
        ...
        SendMessage(body) {
            ...
            ws.send(builder.create("message")
                ...
                .att('to', Jid)
                .att('id', UUID)
                .att("from", "xmpp-admin@BabyHub.dev")
                .ele('body')
                .txt(body)
                .up()
                .toString()
            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "connection": {
                        "id": `BabyHubBot${BotNumber != 0 ? BotNumber : ""}@BabyHub.dev/V2:Fortnite:WIN::BabyHub-Bot-By-BeatYT${BotNumber != 0 ? BotNumber : ""}`,
                        "meta": {
                    ...
                    "account_id": `BabyHubBot${BotNumber != 0 ? BotNumber : ""}`,
                    "account_dn": "BabyHubBot",
                    "member_state_updated": {
                        "urn:epic:member:joinrequestusers_j": JSON.stringify({ "users": [{ "id": `BabyHubBot${BotNumber != 0 ? BotNumber : ""}`, "dn": "BabyHubBot", "plat": "WIN", "data": JSON.stringify({ "CrossplayPreference_i": "1", "SubGame_u": "1" }) }] }),
                        "urn:epic:member:dn_s": `BabyHubBot`,
                    },
                    "joined_at": new Date(),
                    "updated_at": new Date()
                }
