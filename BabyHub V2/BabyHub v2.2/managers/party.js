...
module.exports = (app) => {
                ...
                client.functions.SendMessage(JSON.stringify(
                    {
                        ...
                        "account_id": `BabyHubBot${counter != 0 ? counter : ''}`,
    ...
    app.post('/party/api/v1/*/user/:accountId/pings/:pingerId', (req, res) => {
        ...
        if (req.params.accountId != "BabyHubBot") return;
    ...
    // /party/api/v1/Fortnite/parties/LobbyBotPartyLMFAO/members/BabyHubBot
    app.delete('/party/api/v1/*/parties/:PartyId/members/:accountId', (req, res) => {
        ...
        if (`${req.params.accountId}`.startsWith("BabyHubBot")) {
