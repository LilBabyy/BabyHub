...
module.exports = (app) => {
		...
		res.json([
			{
				...
				"status": "UP",
				"message": "Hi",
				"maintenanceUri": "https://dsc.gg/BabyHub",
				"allowedActions": [],
				"banned": false,
				"launcherInfoDTO": {
					"appName": "Fortnite",
	...
	app.delete("/friends/api/v1/:accountId/friends/BabyHubBot", (req, res) => {
		res.status(403).json({ "errorCode": "errors.com.epicgames.BabyHub.common.forbidden", "errorMessage": "You cannot remove the bot", "messageVars": [], "numericErrorCode": 14004, "originatingService": "party", "intent": "prod" })
	...
	app.post("/friends/api/v1/:accountId/blocklist/BabyHubBot", (req, res) => {
		res.status(403).json({ "errorCode": "errors.com.epicgames.BabyHub.common.forbidden", "errorMessage": "You cannot remove the bot", "messageVars": [], "numericErrorCode": 14004, "originatingService": "party", "intent": "prod" })
	...
	app.get("/account/api/public/account/displayName/:displayName", (req, res) => {
		...
		if (req.params.displayName != "BabyHubBot") return;
	...
	app.post("/friends/api/v1/:accountId/friends/BabyHubBot", (req, res) => {
		res.status(204).send()
	})
	...
	app.get('/affiliate/api/public/affiliates/slug/:affiliateName', (req, res) => {
		if (req.params.affiliateName != "BabyHub") {
