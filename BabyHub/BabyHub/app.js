...
try {
	...
	try {
		var cookieParser = require("cookie-parser");
	} catch { NeoLog.Error('Module install failed, join our discord for more help: https://discord.gg/TUFRj6CE5B'); }
}
...
axios.defaults.headers["user-agent"] = `BabyHubServer/${version} axios/${axiosPackage.version}`;

axios.get('https://raw.githubusercontent.com/BabyHubDev/BabyHubV2/main/package.json', { validateStatus: undefined }).then((response) => {
